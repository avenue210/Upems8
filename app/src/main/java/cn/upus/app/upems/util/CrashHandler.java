...
//			AppManagerUtils.releaseAppResource();
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                Looper.prepare();
                //Toast.makeText(mContext.getApplicationContext(), "程序异常退出，即将重启...", Toast.LENGTH_LONG).show();
                Looper.loop();
            }
        }).start();
        // 收集设备参数信息
...
//		}
        ...
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + System.currentTimeMillis() + ".txt");
