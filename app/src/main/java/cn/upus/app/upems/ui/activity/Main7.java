...
import cn.upus.app.upems.ui.dialog.wangban.WangBan_LoginDialog;
import cn.upus.app.upems.ui.dialog.wangban.WangBan_Out_Dialog;
 ...
 * 网板柜
 */
public class Main7 extends BaseActivity {

    private static final String TAG = Main7.class.getSimpleName();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv1:
                ...
                new WangBan_LoginDialog(this, this, 0).show();
                break;
            case R.id.iv2:
                if (TextUtils.isEmpty(MApp.mSp.getString(UserData.DEVNO)) || TextUtils.isEmpty(MApp.mSp.getString(UserData.WEB_URL))) {
                    showToast(getString(R.string.not_register), 2);
                ...
                new WangBan_LoginDialog(this, this, 1).show();
                break;
        }
    }
