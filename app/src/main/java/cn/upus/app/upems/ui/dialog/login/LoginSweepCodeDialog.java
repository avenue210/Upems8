 ...
 * 23 类型 登录
 */
public class LoginSweepCodeDialog extends BaseDialog {

    private static final String TAG = LoginSweepCodeDialog.class.getSimpleName();
    ...
    public LoginSweepCodeDialog(@NonNull Context context, @NonNull Activity activity) {
        ...
        try {
            ...
            switch (WEB_TYPT) {
                case TYPE_0:
                    ...
                    String mUrl = "http://www.upus.cn/Locker/a.html?fixno=" + fixno + "&compno=" + compno + "&devkind=" + devkind + "&optkind=" + "0" + "&m=5&t=" + DESUtil.encrypt(time);
